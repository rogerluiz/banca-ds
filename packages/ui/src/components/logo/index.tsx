import React, { forwardRef, ElementRef, Ref } from 'react';
import { styled } from '../../themes/config';

export interface LogoProps extends React.ComponentPropsWithRef<'div'> {
  /**
 ...
 * Component Logo
 */
export const Logo = forwardRef<ElementRef<typeof Container>, LogoProps>(
  function (
    { size = 'md', color = 'gray', ...rest }: LogoProps,
...
export { LogoIcon } from './icon';
export { LogoWordmark } from './wordmark';
